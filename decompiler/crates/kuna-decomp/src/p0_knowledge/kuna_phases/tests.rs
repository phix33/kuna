...
fn settable_count_is_155() {
    ...
    // DIV-118).
    assert_eq!(kuna_num_settables(), 155);
    assert_eq!(SETTABLE_TABLE.len(), 155);
}

#[test]
fn tier_counts_are_40_core_61_transform_54_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (40, 61, 54));
}
